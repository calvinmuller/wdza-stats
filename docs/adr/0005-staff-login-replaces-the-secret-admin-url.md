...
> **Superseded in part by [ADR 0007](./0007-players-sign-in-with-steam-to-start-kick-votes.md):** players now sign in with Steam (hand-rolled OpenID, separate from staff auth) to start KickVotes. Staff sign-in is unchanged.
